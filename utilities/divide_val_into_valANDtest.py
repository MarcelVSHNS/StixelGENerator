...
def main():
    val_path = "/home/marcel/workspace/groundtruth_stixel/data/validation"
    test_path = "/home/marcel/workspace/groundtruth_stixel/data/testing"
    ...
    # take the middle one (1/3 of the val data) for testing
